  ...
  return (
    <div className="flex flex-col sm:flex-row w-full space-y-3 px-2 sm:space-y-0 md:gap-8">
      <div className="flex lg:sticky lg:top-22 flex-1 flex-col space-y-2  items-center lg:h-fit">
        <div
          className=" w-37.5 h-37.5 rounded-full border border-gray-700/80
        md:border-none md:border-transparent  md:rounded-sm overflow-hidden"
        >
          <Image
            alt="Photo"
            src="/photo.png"
            ...
            loading="eager"
            height={150}
            className=" object-cover object-top scale-100 md:scale-130"
          />
        </div>
      ...
      <div className="flex-2 space-y-4">
        ...
        <div className="flex flex-col gap-1">
          <div>
            <span className="text-3xl font-extrabold font-pp-neue-montreal text-[#E8DDB5]">
              Tech Stack
            </span>
          </div>
