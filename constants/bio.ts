...
export const BASIC_EXPANDED_INTRO_TEXT = `A ${AGE}-year-old bachelors student from ${PLACE_LIVING}, who's currently diving deep into web development while aspiring to become a skilled AI/ML engineer.`;
